    ...
    public static class ErrorHandler
    {
        ...
        public static void CheckError(object sender, ErrorCode errorCode)
        {
            ...
            else
            {
                ...
                {
                    if (NonSevereErrorHappenedEvent != null)
                    {
                        foreach (SDKExceptionHandler handler in NonSevereErrorHappenedEvent.GetInvocationList())
                        {
                            await Task.Run(() => handler.Invoke(sender, errorCode));
                        }
                    }
                });
            }
        ...
        public static bool ReportError(object sender, Exception ex)
        {
            ...
            else
            {
                Task.Run(() =>
                {
                    SevereErrorHappenedEvent(sender, ex);
                });
                return true;
            }
        }
