    ...
    public class Camera : IDisposable
    {
        ...
        public void TakePhotoShutter()
        {
            ...
            MainThread.Invoke(() =>
            {
                try
                {
                    SendCommand(CameraCommand.PressShutterButton, (int)ShutterButton.Halfway);
        ...
        public void DownloadFile(DownloadInfo Info, string directory, string fullPath)
        {
            CheckState();
